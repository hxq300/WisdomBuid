...
public class EasySeekBar extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            bgColor = typedArray.getColor(R.styleable.EasySeekBar_progress_bg_color, Color.parseColor("#ffffff"));
            ...
            line = typedArray.getDimensionPixelOffset(R.styleable.EasySeekBar_line,300);
...
//                canvas.drawLine(0,0,0,0,bgPaint);
//                canvas.drawLine(0,0,0,0,progressPaint);

//                canvas.drawCircle(progress+WHPoint.y/2,WHPoint.y/2,circleR,circlePaint);
                canvas.drawCircle(0,0,0,circlePaint);
                break;
            case "vertical":
