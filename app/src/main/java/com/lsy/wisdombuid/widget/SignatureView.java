...
import com.lsy.wisdombuid.util.Bezier;
import com.lsy.wisdombuid.util.ControlTimedPoints;
import com.lsy.wisdombuid.util.TimedPoint;
...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mMaxWidth = a.getDimensionPixelSize(R.styleable.SignatureView_maxWidth, convertDpToPx(10));
