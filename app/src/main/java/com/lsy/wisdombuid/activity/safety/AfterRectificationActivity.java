 ...
 * todo : 待整改
 */
public class AfterRectificationActivity extends MyBaseActivity {
    ...
    private void initView() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(AfterRectificationActivity.this);
...
//        {"pageNo":1,"pageSize":10,"section_id":2}
        ...
        listcanshu.put("section_id", OKHttpClass.getToken(AfterRectificationActivity.this));//标段ID登录返回
        listcanshu.put("station_id", station_id);//站点ID(下拉框里面选的)

        L.log("record", "station_id===" + OKHttpClass.getToken(AfterRectificationActivity.this));

        //设置请求类型、地址和参数
        okHttpClass.setPostCanShu(AfterRectificationActivity.this, RequestURL.safetyAfterRectification, listcanshu);
            ...
            public String requestData(String dataString) {
                ...
                try {
                    ...
                    if (dataList != null && dataList.size() > 0) {
                        listAdapter = new AfterRectificationAdapter(AfterRectificationActivity.this, dataList,1);
