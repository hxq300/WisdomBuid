...
public class InsRecordDetailsActivity extends MyBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sharedUtils = new SharedUtils(InsRecordDetailsActivity.this, SharedUtils.WISDOM);
...
//        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(RectificationNoticeActivity.this);
    ...
    private void initData() {
        ...
        if (data != "" || !data.equals("")) {
            ...
            ToastUtils.showBottomToast(InsRecordDetailsActivity.this, "获取数据失败");
        }
        ...
        listAdapter = new RectNoticeAdapter(InsRecordDetailsActivity.this, images);
...
//        传参:id(隐患数据id,数据类型:int),integral(积分,数据类型:String),state(有效/无效,数据类型:String),staff_id(员工id安全隐患记录返回的数据,数据类型:int)
        ...
        //设置请求类型、地址和参数
        okHttpClass.setPostCanShu(InsRecordDetailsActivity.this, RequestURL.safetyAudit, listcanshu);
            ...
            public String requestData(String dataString) {
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        ToastUtils.showBottomToast(InsRecordDetailsActivity.this, "" + message);
                    }
