 ...
 * todo : 整改通知单
 */
public class RectificationNoticeActivity extends MyBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rectification_notice);
        ...
        sharedUtils = new SharedUtils(RectificationNoticeActivity.this, SharedUtils.WISDOM);
...
//            reStation, reUpdate, reGongxu, reTongzhi, rePlanTime;
            ...
            ToastUtils.showBottomToast(RectificationNoticeActivity.this, "获取数据失败");
        }
        ...
        listAdapter = new RectNoticeAdapter(RectificationNoticeActivity.this, images);
